...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        String[] kisiler ={"Adem", "Ayse","Mahmut","Mehmet"};
        int kisiIndex =(int) (Math.random()* kisiler.length);
        String secilenKitap = okunacakKitaplar.get(deger);

        System.out.println(kisiler[kisiIndex]+" Hanım/Bey Okuyacağınız kitap :"+secilenKitap);
    }
